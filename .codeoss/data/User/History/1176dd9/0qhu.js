...
function processRejectionEmails() {
  ...
  const rejectionKeywordsEN = [
    ...
    '"careful consideration"', '"we have decided"', '"we will not be moving"'
  ];
  const rejectionKeywordsDE = [
    '"leider"', '"absage"', '"andere Kandidaten"', '"für andere Kandidat"',
    '"nicht weiterverfolgen"', '"keinen positiven Bescheid"', '"eingehender Prüfung"',
    '"sorgfältiger Prüfung"', '"nicht berücksichtigen"', '"haben wir uns entschieden"'
  ];
