...
function updateGeoData() {
  ...
  if (!geoSheet) {
    ...
    // Delete and recreate to remove all column types and formatting
    const position = geoSheet.getIndex();
    ss.deleteSheet(geoSheet);
    geoSheet = ss.insertSheet("Geo_Data", position - 1);
  }
  ...
  // Write everything including header in one block as plain text
