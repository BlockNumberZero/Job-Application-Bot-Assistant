...
function savePdfGhostFree(letterText, company, isDe, tempDocTitle) {
  ...
  try {
    ...
    Logger.log(`Error creating PDF file in Drive folder ${PDF_FOLDER_ID}: ${e.toString()}`);
